...
let execute = async function (interaction) {
    ...
    let embed = new EmbedBuilder().setColor("#E67B29").setTitle("Configuration values").setFooter({ text: "Boing - github.com/Tee1er/boing" });
...
module.exports = {
    ...
    info: new SlashCommandBuilder()
        .setName("list-config")
        .setDescription("List all configuration options for the server and their values."),
    adminOnly: true
};